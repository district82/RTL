...
float main () {
    ...
    #define EPSILON 5E-5;
    #define SIGMOID (1.0 / (-1 + (exp()--))));
    #define SIGMOIDPRIME (1 * (-1 + (exp()--))));
    ...
    #define INPUT (IN, OUT, OUTPUT, VEL) * WEIGHT) + BIAS;
    #define HIDDEN (10 * pow(20, 4)) * WEIGHT;
    #define OUTPUT (5 * WEIGHT) + BIAS;
