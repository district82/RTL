 ...
 * In summary, the code says this is your frequency, these are your paramenters, this
 * is what time is logically, now think about it and question your own logic
 * @Created and finished between 04.09.2020 and 05.09.2020 updated on 19.12.2020
 * @Listening Peace Orchestra.
 * @By Russell A E Clarke Et. al notes: https://www.russellclarke.co.uk/
 */
...
float V;
float PI;
float DIM = 3; //could be 3rd dimension for example. Set the value here or in the method, Method preferred.
float SIG;
float VEL;
float IN;
float RAD = 1;
